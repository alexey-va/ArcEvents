...
class ArcEventsLocale(
    ...
    companion object {
        val REQUIRED_SCALARS = setOf(
            ...
            "chat.self-message", "chat.match-message", "chat.spectator-message",
            "chat.range.close", "chat.range.normal", "chat.range.far", "chat.range.global",
            "arena.auto.name", "arena.citadel.name", "arena.ttt-minecraft-b5.name", "arena.inferno.name", "arena.mirage.name",
            "arena.nuke.name", "arena.fishing.name",
            ...
            "arcade.gungame-title", "arcade.gungame-name", "arcade.disasters-title", "arcade.disasters-name",
            "arcade.gungame-guide-name", "arcade.disasters-guide-name", "arcade.join-name", "arcade.leave-name",
            "arcade.start-name", "arcade.status-name", "arcade.unsupported-mode",
            "arcade.fishing-title", "arcade.fishing-name", "arcade.fishing-guide-name", "arcade.fishing-start-name",
            "arcade.fishing-unavailable-name", "arcade.fishing-loading-name", "arcade.fishing-dialog-unavailable",
            "arcade.preparing", "arcade.countdown", "arcade.started", "arcade.hud", "arcade.gungame-hud", "arcade.disasters-hud", "arcade.fishing-hud", "arcade.result",
            "arcade.eliminated", "arcade.respawn", "arcade.disaster-warning", "arcade.hazard-meteors",
            "arcade.hazard-lightning", "arcade.hazard-fog", "arcade.hazard-meteors-guide",
            "arcade.hazard-lightning-guide", "arcade.hazard-fog-guide", "arcade.round-complete",
            "arcade.knife-name", "arcade.no-winners", "arcade.status",
            ...
            "fishing.result-success", "fishing.result-timeout", "fishing.result-defeat",
            "fishing.rod-name", "fishing.weapon-0-name", "fishing.weapon-1-name", "fishing.weapon-2-name",
            "fishing.start", "fishing.catch", "fishing.complete", "fishing.travel-unlocked", "fishing.creature-defeated",
            "fishing.creature-hit", "fishing.hud", "fishing.creature-name", "fishing.boss-name", "fishing.boss-summoned",
            "fishing.creature-summoned", "fishing.creature-missing", "fishing.boss-warning", "fishing.travel-started", "fishing.travel-marker",
            "fishing.invalid-catch", "fishing.encounter-restored", "fishing.telegraph",
            "fishing.phase.casting", "fishing.phase.bite", "fishing.phase.creature", "fishing.phase.travel",
            "fishing.phase.boss", "fishing.phase.complete", "fishing.phase.closed",
        ...
        val REQUIRED_LISTS = setOf(
            ...
            "arcade.gungame-lore", "arcade.gungame-guide", "arcade.disasters-lore", "arcade.disasters-guide",
            "arcade.fishing-lore", "arcade.fishing-guide", "arcade.fishing-start-lore", "arcade.fishing-unavailable-lore", "arcade.fishing-loading-lore",
            "fishing.rod-lore", "fishing.weapon-lore",
            "arcade.join-lore", "arcade.leave-lore", "arcade.start-lore", "arcade.status-lore",
            "arcade.knife-lore",
